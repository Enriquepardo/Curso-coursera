#Vamos a modificar el código que acabamos de ver para encapsular algunas partes de él en funciones.
...
def obtener_genero():
    sexo = input("Indíca tu género (Masculino/Femenino/Otro): ")
    return sexo
...
############################################################
# El código anterior era solamente definiciÃ³n de funciones que serÃ¡n usadas mÃ¡s adelante
...
while opcion != 0:
    ...
    #código para la opciÃ³n 1. Publicar un mensaje.
    if opcion == 1:
        mensaje = obtener_mensaje()
        mostrar_mensaje(nombre, None, mensaje)

    #código para la opciÃ³n 2. Publicar un mensaje a un grupo de personas.
    elif opcion == 2:
        mensaje = obtener_mensaje()
    ...
    #código para la opciÃ³n 3. Publicar los datos del perfil del usuario.
    elif opcion == 3:
        mostrar_perfil(nombre, edad, estatura_m, estatura_cm, num_amigos)

    #código para la opciÃ³n 4. Actualizar los datos del perfil del usuario.
    elif opcion == 4:
        nombre = obtener_nombre()
        edad = obtener_edad()
        (estatura_m, estatura_cm) = obtener_estatura()
